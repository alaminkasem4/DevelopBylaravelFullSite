	...
	<section class="header">
		<div class="container">
			<nav class="navbar navbar-expand-md navbar-light">
				<a href="{{url('/')}}" class="navbar-brand"><img src="{{url('upload/logo_img/'.$logo->image)}}" alt="Logo" style="height: 50px;"></a>
				...
				<div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
					<div class="navbar-nav popular">
						...
						<a href="{{route('our.newsEvent')}}" class="nav-item nav-link">News and Event</a>
