  ...
  <div class="content-wrapper">
    ...
    <section class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{route('visions.store')}}" method="post" id="From_id" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
            	
     		     <div class="form-group col-md-12">
                <label for="text">Text</label>
                <textarea name="text" class="form-control" rows="4" placeholder="Please Write some text"></textarea>
              </div>
